...
class Player {
    ...
    bind() {
        ...
        swiper.on('swipLeft', function () {
            ...
            self.$$('.balls span')[0].classList.remove('current')
            self.$$('.balls span')[1].classList.add('current')
            console.log('left')
        })
        ...
        swiper.on('swipRight', function () {
            ...
            self.$$('.balls span')[0].classList.add('current')
            self.$$('.balls span')[1].classList.remove('current')
            console.log('right')
        })
    }
